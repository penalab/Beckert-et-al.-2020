%%
% load('K:\Data\Data\Analysis\Data\FreeFieldRawDATA_notsidecorrected_FFffomitted.mat','OT');
...
pattern2 = 'FFf1';                   % These are to keep
f = 'ff';
...
cd('K:\WorkingFolder')
save ot_synch_ff_del_fr_200_cor_FFf1only
