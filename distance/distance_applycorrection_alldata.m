...
for t = 1:size(icls, 1)
    switch t
        ...
        case 3
            load('K:\WorkingFolder\distance\altcorrections\distance_correction_0_p4_c040_q_100.mat', 'key', 'cfun')
...
for t = 1:size(ot, 1)
    switch t
        ...
        case 3
            ...
            load('K:\WorkingFolder\distance\varyingQ\otAZ_distance_100_omit_removeFirstSpike.mat', 'distanceEuc', 'distanceVP', 'distanceES', 'Mean')
            E = distanceEuc; V = distanceVP; S = distanceES; M = Mean;
            clear distanceEuc distanceVP distanceES Mean
        case 4
            load('K:\WorkingFolder\distance\altcorrections\distance_correction_0_p4_c010_q_100.mat', 'key', 'cfun')
            load('K:\WorkingFolder\distance\varyingQ\otEL_distance_100_omit_removeFirstSpike.mat', 'distanceEuc', 'distanceVP', 'distanceES', 'Mean')
            E = distanceEuc; V = distanceVP; S = distanceES; M = Mean;
            clear distanceEuc distanceVP distanceES Mean
        case 5
            load('K:\WorkingFolder\distance\altcorrections\distance_correction_0_p4_c020_q_100.mat', 'key', 'cfun')
...
% special = cell(2, 1);
% 
% load('K:\WorkingFolder\distance\data\distance_correction_c_01_10_long.mat', 'key', 'cfun')
% 
...
%     switch t
%         case 1
%             load('K:\WorkingFolder\distance\data\distance_ot_betweenspeakers_noonset.mat', 'distanceEuc', 'distanceVP', 'distanceES', 'Mean')
%             E = distanceEuc; V = distanceVP; S = distanceES; M = Mean;
...
%             clear distanceEuc distanceVP distanceES Mean
%         case 2
%             load('K:\WorkingFolder\distance\data\distance_betweenneurons_del_noonset.mat', 'EUC', 'VP', 'ES', 'FR1', 'FR2')
%             
...
save distance_corrected_data_100_omit_removeFirstSpike