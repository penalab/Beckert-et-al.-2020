...
save otFF_distance_100_removeFirstSpike
%%
cd('K:\WorkingFolder')
load('K:\WorkingFolder\tetrodekeys\SpeakerIndex.mat','SpeakerIndex')

for t = 1:2
    load('otFF_distance_100_removeFirstSpike.mat');
    ...
    switch t
        case 1
            save otAZ_distance_100_removeFirstSpike distanceES distanceEuc distanceVP Mean
        case 2
            save otEL_distance_100_removeFirstSpike distanceES distanceEuc distanceVP Mean
    end
