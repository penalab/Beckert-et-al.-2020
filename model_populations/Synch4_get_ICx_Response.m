function Synch4_get_ICx_Response(repet, ITD, dir_name)
...
eval(['load ' dir_name 'SynchResults\data\iccl\SynchICcl_ITD' num2str(ITD) '_' r_txt '_reducedSNR spikesICcl T BITD CF'])
...
eval(['save ' dir_name 'SynchResults\data\icx\SynchICx_ITD' num2str(ITD) '_' r_txt '_reducedSNR spikesICx Rate'])
