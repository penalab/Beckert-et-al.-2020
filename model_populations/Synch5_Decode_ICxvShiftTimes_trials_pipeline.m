function Synch5_Decode_ICxvShiftTimes_trials_pipeline(repet, ITD_input, dir_name, SNR_ICcl, SNR_ICx, ICx_weight, ICx_side, ICx_width, freq_width, BW, gainL, gainU)
