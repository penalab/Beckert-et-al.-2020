function Synch4_get_ICx_Response_reducedSNR(repet, ITD, dir_name, SNR_ICcl, SNR_ICx, ICx_weight, ICx_width, freq_width)
...
eval(['load ' dir_name 'SynchResults\data\SynchParms_SNR' num2str(SNR_ICcl * 10) ' bestITD bestF We Wi tau_syn BW NP SNR_ICx '])
...
eval(['save ' dir_name 'SynchResults\data\icx\SynchICx_ITD' num2str(ITD) '_' r_txt '_SNR' num2str(SNR_ICcl * 10) ' spikesICx Rate'])
