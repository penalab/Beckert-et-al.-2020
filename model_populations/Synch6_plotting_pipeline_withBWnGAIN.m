cd('K:\python\model_icx_codeonly\SynchResults\data\testingvars_BWngain')
...
for ITD = itds
    ...
    if isfile([dir_name 'SynchResults\data\testingvars_BWngain\modelout_ITD' num2str(ITD) '_' r_txt ...
...
GAIN = params_used(p, 10);
    ...
    eval(['load ' dir_name 'SynchResults\data\testingvars_BWngain\modelout_ITD' num2str(ITD) '_' r_txt ...
        '_SNRICcl' num2str(SNR_ICcl * 10) ...
        '_SNRICx' num2str(SNR_ICx * 100000) ...
        '_ICxweight' num2str(ICx_weight * 10) ...
        '_ICxside' num2str(ICx_side * 10) ...
