function Synch1_Model_Parameters_Wweight_pipeline(SNR_ICcl, SNR_ICx, ICx_weight, ICx_side, ICx_width, freq_width, BW, W_weight)
tic
...
eval(['save ' dir_name 'SynchResults\data\SynchParms_SNRICcl' num2str(SNR_ICcl * 10) ...
    ...
    ' CF BITD s BW SNR_ICcl bestITD bestF We Wi SNR_ICx NP tau_syn ICx_weight ICx_side ICx_width freq_width W_weight'])
toc