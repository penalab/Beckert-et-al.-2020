function Synch3_get_ICcl_Response_reducedSNR(repet, ITD, dir_name, params_name)
...
eval(['load ' params_name ' s BW SNR_ICcl BITD tau_syn NP'])

%% Load cross correlation inputs at given ITD

eval(['load ' dir_name 'SynchResults/data/cc/SynchCC_ITD' num2str(ITD) '_001 CF Ts Ts2 X'])
...
eval(['save ' dir_name 'SynchResults/data/iccl/SynchICcl_ITD' num2str(ITD) '_' r_txt '_SNR' num2str(SNR_ICcl * 10) ' R spikesICcl SNR_ICcl BW s NP T BITD CF'])
