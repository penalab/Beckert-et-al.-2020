function Synch4b_AM_adjust_ICx_Response_fromshift_RunNCalc_pipeline(repet, ITD_input, dir_name, SNR_ICcl, SNR_ICx, ICx_weight, ICx_side, ICx_width, freq_width)
