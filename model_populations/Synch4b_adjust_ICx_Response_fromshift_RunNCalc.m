% Synch4_get_ICx_Response_fromshift(20, 'K:\python\model_icx_codeonly\')

%%

% load('model_synch_icx_shifttest_50.mat')
load('K:\python\model_icx_codeonly\SynchResults\data\icx\SynchICx_ITD100_001_SNR20.mat')
...
spikesICx = cellfun(@(x) x(x > 0 & x < dur), spikesICx, 'UniformOutput', 0);
...
save('K:\python\model_icx_codeonly\SynchResults\data\icx\SynchICx_ITD100_001_SNR20_shiftshuff.mat')
