function Synch5_Decode_ICxvShiftTimes_trials_pipeline_testingfmin_thresh_updated(repet, ITD_input, dir_name, SNR_ICcl, SNR_ICx, ICx_weight, ICx_side, ICx_width, freq_width, BW, gainL, gainU, fmin, W_weight, bin, VT, Vi)
...
eval(['load ' dir_name 'SynchResults\data\icx\SynchICx_ITD' num2str(ITD_input) '_' r_txt ...
    ...
    '_shiftshuff spikesICx GM syn synch_varying Rate'])
