function Synch5_Decode_AM_ICxvShiftTimes_trials_pipeline(repet, ITD_input, dir_name, SNR_ICcl, SNR_ICx, ICx_weight, ICx_side, ICx_width, freq_width)
...
eval(['load ' dir_name 'SynchResults\data\iccl\SynchICcl_ITD' num2str(ITD_input) '_' r_txt '_SNR' num2str(SNR_ICcl * 10) ' T'])
eval(['load ' dir_name 'SynchResults\data\SynchParms_SNRICcl' num2str(SNR_ICcl * 10) ...
    ...
    ' bestITD bestF NP'])
eval(['load ' dir_name 'SynchResults\data\cc\SynchCC_ITD' num2str(ITD_input) '_' r_txt ' Ts2'])
