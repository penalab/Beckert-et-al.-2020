cd('K:\python\model_icx_codeonly\SynchResults\data\testingvars_BWndynamicGainGe')
...
for ITD = itds
    ...
    if isfile([dir_name 'SynchResults\data\testingvars_BWndynamicGainGe\modelout_ITD' num2str(ITD) '_' r_txt ...
...
GAINU = params_used(p, 11);
    ...
    eval(['load ' dir_name 'SynchResults\data\testingvars_BWndynamicGainGe\modelout_ITD' num2str(ITD) '_' r_txt ...
        '_SNRICcl' num2str(SNR_ICcl * 10) ...
        '_SNRICx' num2str(SNR_ICx * 100000) ...
        '_ICxweight' num2str(ICx_weight * 10) ...
        '_ICxside' num2str(ICx_side * 10) ...
